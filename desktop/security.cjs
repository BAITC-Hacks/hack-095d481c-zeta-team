...
const ASSETS=new Set(['/index.html','/assets/style.css','/assets/favicon.svg','/assets/xlsx.js','/assets/engine.js','/assets/app.js','/assets/project.js','/assets/workspace.js']);
