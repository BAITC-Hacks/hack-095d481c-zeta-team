...
const ASSETS=new Set(['/index.html','/assets/style.css','/assets/favicon.svg','/assets/xlsx.js','/assets/engine.js','/assets/planner.js','/assets/privacy.js','/assets/engine-worker.js','/assets/app.js','/assets/project.js','/assets/workspace.js']);
