...
function key(){if(!globalThis.crypto?.subtle)throw Error("Для обезличивания клиентов откройте приложение через HTTPS или http://127.0.0.1:8000/.");return keyPromise??=(crypto.subtle.generateKey({name:'HMAC',hash:'SHA-256'},false,['sign']));}
