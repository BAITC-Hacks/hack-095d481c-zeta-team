...
if(D){$('.local-badge').innerHTML='<svg><use href="#i-shield"/></svg>OFFLINE · Desktop';$('.version').innerHTML='<span class="online-dot"></span>Desktop edition <span>v1.0</span>';D.onCommand(command);}
